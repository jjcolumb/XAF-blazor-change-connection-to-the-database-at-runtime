...
using XAFBlazorDbChooser.Blazor.Server.Services;
using XAFBlazorDbChooser.Module.BusinessObjects;
using Microsoft.AspNetCore.Http;
using Microsoft.JSInterop;

namespace XAFBlazorDbChooser.Blazor.Server
{
    public partial class XAFBlazorDbChooserBlazorApplication : BlazorApplication
    {
        public XAFBlazorDbChooserBlazorApplication()
        {
            InitializeComponent();
        }
        ...
        private void XAFBlazorDbChooserBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
